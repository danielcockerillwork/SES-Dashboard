...
export function SettingsClient({ initialSettings, initialNotice = null }: SettingsClientProps) {
  ...
  const [includeContactDefault, setIncludeContactDefault] = useState(initialSettings.includeContactDefault);
  const [excludedServiceNames, setExcludedServiceNames] = useState<string[]>(initialSettings.excludedServiceNames);
